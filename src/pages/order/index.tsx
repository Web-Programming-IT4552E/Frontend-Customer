      ...
      <div className='mt-12'>
        ...
        <div className='grid grid-cols-1 gap-12 sm:grid-cols-6 lg:gap-32 '>
          ...
          >
            ...
            <Form.Item name='district' label='District' rules={[{ required: false }]}>
              <Select placeholder='Select district' onChange={() => {}} allowClear>
                <Option value='male'>male</Option>
                <Option value='female'>female</Option>
                <Option value='other'>other</Option>
              </Select>
          ...
          <div className='col-span-2 flex w-full flex-col gap-10'>
            ...
            <div>
              <h1 className='mb-5 text-[15px] font-bold uppercase tracking-widest'>Voucher:</h1>
              <span>---</span>
            </div>
            <div>
            ...
            <div>
              <h1 className='mb-5 text-[15px] font-bold uppercase tracking-widest'>Total point:</h1>
              <span>0 point</span>
            </div>
            <div>
              <h1 className='mb-5 text-[15px] font-bold uppercase tracking-widest'>
